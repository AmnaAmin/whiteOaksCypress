...
export const createForm = (form, values, signatureDimention, imageUrl) => {
  ...
  const xHeading1 =
    (form.internal.pageSize.getWidth() - form.getTextWidth(headings.first)) / 2;
  ...
  const xHeading2 =
    (form.internal.pageSize.getWidth() - form.getTextWidth(headings.second)) /
    2;
  ...
  form.setFont(undefined, "bold");
  const xHeading3 =
    (form.internal.pageSize.getWidth() - form.getTextWidth(headings.third)) / 2;
  ...
  // // exceptions
  const xHeading4 =
    (form.internal.pageSize.getWidth() - form.getTextWidth(headings.fourth)) /
    2;
  form.setFont(undefined, "bold");
  ...
  // Signature
  const xHeading5 =
    (form.internal.pageSize.getWidth() - form.getTextWidth(headings.fifth)) / 2;
  form.setFont(undefined, "bold");
  ...
  form.text(
    `${dateOfSignature}: ${
      values.dateOfSignature ? dateFormat(values.dateOfSignature) : ""
    }`,
    20,
    o
  );
...
export const useLienWaiverMutation = () => {
  ...
  return useMutation((payload) =>
    client(`work-orders`, { data: payload, method: "PUT" })
  );
};
