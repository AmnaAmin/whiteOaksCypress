    ...
    <>
        ...
        <HStack alignItems={'flex-start'}>
          <VStack w="33%" alignItems={'flex-start'}>
            ...
            <Controller
              control={control}
              name={`advancedPermissions.disableContactsForFpmAccountingPcandCo`}
              render={({ field, fieldState }) => (
                <>
                  <Checkbox
                    colorScheme="PrimaryCheckBox"
            ...
            <Controller
              control={control}
              name={`advancedPermissions.canChangeGateCode`}
              render={({ field, fieldState }) => (
                <>
                  <Checkbox
                    colorScheme="PrimaryCheckBox"
            ...
            <Controller
              control={control}
              name={`advancedPermissions.canChangeLockBox`}
              render={({ field, fieldState }) => (
                <>
                  <Checkbox
                    colorScheme="PrimaryCheckBox"
            ...
            <Controller
              control={control}
              name={`advancedPermissions.allowUserToCreateCarrierFeeOnApprovedInvoicedStates`}
              render={({ field, fieldState }) => (
                <>
                  <Checkbox
                    colorScheme="PrimaryCheckBox"
