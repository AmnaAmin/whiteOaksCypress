    ...
    <Stack w={{ base: '971px', xl: '100%' }} spacing={5}>
      {isLoading ? (
        ...
        <Tabs variant="enclosed" index={tabIndex} onChange={index => setTabIndex(index)}>
          <TabList>
            <Tab _selected={{ color: 'white', bg: 'button.300' }}>{t('details')}</Tab>
            <Tab _selected={{ color: 'white', bg: 'button.300' }}>{t('documents')}</Tab>
            <Tab _selected={{ color: 'white', bg: 'button.300' }}>{t('license')}</Tab>
            <Tab _selected={{ color: 'white', bg: 'button.300' }}>{t('trade')}</Tab>
            <Tab _selected={{ color: 'white', bg: 'button.300' }}>{t('market')}</Tab>
          </TabList>

          <TabPanels mt="31px">
            <TabPanel p="0px" data-testid="detailsTab">
