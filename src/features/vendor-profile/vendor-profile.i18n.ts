  ...
  en: {
    translation: {
      [VENDORPROFILE]: {
        ...
        changeFieldMessage: 'your input has been changed,please save.',
        discardChanges: 'Discard changes',
        downloadACFForm: 'Download ACH Form',
      },
    },
  },
  es: {
    translation: {
      [VENDORPROFILE]: {
        ...
        changeFieldMessage: 'su entrada ha sido modificada, guarde.',
        discardChanges: 'Descartar los cambios',
        downloadACFForm: 'Descargar Formulario ACH',
      },
    },
  },
}
