...
const ProjectDetailsTab = (props: tabProps) => {
  ...
  const { isInvoiceAndPaymentFormErrors, isProjectManagementFormErrors, isContactsFormErrors } = useSubFormErrors(errors)
      ...
      <form onSubmit={formReturn.handleSubmit(onSubmit)} id="project-details">
        <Tabs variant={tabVariant || 'line'} colorScheme="brand" onChange={handleTabsChange}>
          ...
          >
            ...
            <TabCustom isError={isContactsFormErrors && tabIndex !== 2} >{t(`project.projectDetails.contacts`)}</TabCustom>
