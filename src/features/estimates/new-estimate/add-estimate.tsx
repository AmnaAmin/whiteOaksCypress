...
import { AddEstimateInfo } from './add-estimate-info'
...
const AddEstimateForm: React.FC<AddProjectFormProps> = ({ onClose }) => {
          ...
          <Tabs colorScheme="brand" variant="enclosed" index={tabIndex} onChange={index => setTabIndex(index)} mt="3">
            ...
            <TabPanels mt="31px" h="100%">
              <TabPanel p="0px" h="100%">
                <AddEstimateInfo setNextTab={setNextTab} onClose={onClose} />
              </TabPanel>
              <TabPanel p="0px" h="100%">
                <AddPropertyInfo
                  isLoading={false}
...
export const AddNewEstimateModal: React.FC<UpdateProjectProps> = ({ isOpen, onClose }) => {
  const { t } = useTranslation()
  return (
    <Modal
      isOpen={isOpen}
...
export const UpdateEstimateModal: React.FC<UpdateProjectProps> = ({ isOpen, onClose, selectedProjectId }) => {
  return (
