...
export default function useRoutesConfig() {
  return [
    ...
    { path: 'projects', element: Projects, permissions: ['PROJECT.READ', 'PROJECT.EDIT'] },
    { path: 'project-details/:projectId', element: ProjectDetails, permissions: ['PROJECT.READ', 'PROJECT.EDIT'] },
    { path: 'estimates', element: Estimates, permissions: ['ESTIMATE.READ', 'ESTIMATE.EDIT'] },
    {
      path: 'estimate-details/:projectId',
      element: EstimateDetails,
      permissions: ['ESTIMATE.READ', 'ESTIMATE.EDIT'],
    },
    ...
    { path: 'vendors', element: Vendors, permissions: ['VENDOR.READ', 'VENDOR.EDIT'] },
    { path: 'clients', element: Clients, permissions: ['CLIENT.READ', 'CLIENT.EDIT'] },
    { path: 'reports', element: Reports, permissions: ['REPORT.READ'] },
    { path: 'markets', element: Markets, permissions: ['MARKET.READ', 'MARKET.EDIT'] },
    { path: 'performance', element: PerformanceTab, permissions: ['PERFORMANCE.READ', 'PERFORMANCE.EDIT'] },
    { path: 'vendorSkills', element: VendorSkills, permissions: ['VENDORSKILL.READ', 'VENDORSKILL.EDIT'] },
    { path: 'alerts', element: Alerts, permissions: ['ALERT.READ', 'ALERT.EDIT'] },
