    ...
    <>
      ...
      <Tabs variant="enclosed" colorScheme="brand">
        ...
        <Flex justifyContent="flex-end" alignItems="center">
          <Button mt="-54px" data-testid="add-user" colorScheme="brand" onClick={props.onOpenUserModal} leftIcon={<BiAddToQueue />}>
            {t(`${USER_MANAGEMENT}.modal.addUser`)}
          </Button>
        </Flex>
        <Card mt="1px" rounded="0px" roundedRight={{ base: '0px', md: '6px' }} roundedBottom="6px" pr={{ base: 0, sm: '15px' }}>
          <TabPanels>
            <TabPanel px={0}>
